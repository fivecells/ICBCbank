...
function showLogonDiv(serviceId,transData,logoffstat){
	...
	if($.browser.msie && parseInt($.browser.version)<=8){
		frames['ICBC_login_frame_f'].location="${pageContext.request.contextPath}/login/login.jsp?StructCode=1&orgurl=0&STNO=31";
	}
...
function hideLogonDiv(){
    ...
    if(isFreashFrame!="" && isFreashFrame!="0"){//关闭登录窗口后刷新首页面
    	//window.location="${pageContext.request.contextPath}/icbc/newperbank/perbank3/frame/frame_index.jsp";//reload();
