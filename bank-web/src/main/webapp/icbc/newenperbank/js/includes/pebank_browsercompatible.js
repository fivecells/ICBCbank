...
//		}
		history.go=function(){
			//alert("由于您的Safari浏览器版本过低，后退操作会使您直接退出网银，建议您升级最新版Safari浏览器。");
			try{
				top.pebankBrowserCompatible.alertHistoryTip();
			}catch(e){
				pebankBrowserCompatible.alertHistoryTip();
			}
...
if(pebankBrowserCompatible.isFirefox()){
	...
	window.alert=function(t){try{_alert(t + '\n\n\n\n' + 'Tip：for your normal experience, please uncheck "prevent this page from creating another dialog box"');}catch(e){}};	
	var _confirm=window.confirm;
	window.confirm=function(t){try{return _confirm(t + '\n\n\n\n' + 'Tip：for your normal experience, please uncheck "prevent this page from creating another dialog box"');}catch(e){return false;}};		
...
BrowserCompatible.prototype.alertHistoryTip = function(){
	...
	if(document.getElementById("alerthistorytip-outbackground")==null){
		var html = "<div id='alerthistorytip-outbackground' style='z-index:5000;width:100%;height:100%;position:fixed;top:0px;left:0px;background-color:rgba(0,0,0,0.25);'>";
//		var html = "<div id='alerthistorytip-outbackground' style='z-index:5000;width:100%;height:100%;position:absolute;top:0px;left:0px;background-color:rgba(0,0,0,0.25);'>";
		html = html + "<div id='alerthistorytip-innerbackground' style='width:500px;height:250px;margin:300px auto 0px;background-color:rgb(238,238,255);-webkit-box-shadow:0px 0px 6px #000;'>";
		...
		if(pebankBrowserCompatible.isSafari()){
			html=html+"Sorry, currently no support on such step. Do not click \"Return\", \"DELETE\" on Safair browser which will go back to the previous webpage. This will cause the transaction to be submitted again. We recommend you to choose the transaction again from the menu.";
		...
		//	html=html+"对不起，暂不支持该操作，同时请勿点击Chrome浏览器后退按钮、Backspace等会导致页面后退的操作，这样可能会影响您的客户体验。建议您从菜单中重新选择交易。";
			html=html+"Sorry, currently no support on such step. Do not click \"Return\", \"BACKSPACE\" on Chrome browser which will go back to the previous webpage. This will cause the transaction to be submitted again. We recommend you to choose the transaction again from the menu.";
		}
		html=html+"</div>";
		html=html+"</div>";
		html = html + "<div id='alerthistorytip-inner-bottom' style='text-align:center;float:left;width:100%;margin-top:15px;'>";
		html=html+"<a href='javascript:pebankBrowserCompatible.hideTip()'><img src='/icbc/newenperbank/images/bt44.gif' border='0'/></a>";
		html=html+"</div>";
		html=html+"</div>";
		html=html+"</div>";
		html=html+"</div>";
