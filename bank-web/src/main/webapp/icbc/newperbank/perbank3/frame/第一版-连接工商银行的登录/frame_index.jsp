...
<link ref="bookmark" type="image/x-icon" href="/icbc/newperbank/perbank3/css/frame/images/favicon.ico" mce_href="/icbc/newperbank/perbank3/css/frame/images/favicon.ico">
<link ref="icon" type="image/x-icon" href="/icbc/newperbank/perbank3/css/frame/images/favicon.ico" mce_href="/icbc/newperbank/perbank3/css/frame/images/favicon.ico">
<link ref="shortcut icon" type="image/x-icon" href="/icbc/newperbank/perbank3/css/frame/images/favicon.ico" mce_href="/icbc/newperbank/perbank3/css/frame/images/favicon.ico">
<link href="/icbc/newperbank/perbank3/style/style_default/css/base.css?ver=2017122122" rel="stylesheet" type="text/css"/>
<link href="
/icbc/newperbank/perbank3/css/frame/css/style.css?ver=2017122122" rel="stylesheet" type="text/css"/>
<link href="
/icbc/newperbank/perbank3/css/new_headerFooter.css?ver=2017122122" rel="stylesheet" type="text/css"/>
<link href="
/icbc/newperbank/perbank3/css/frame/css/index.css?ver=2017122122" rel="stylesheet" type="text/css"/>
...
<script src="
/icbc/newperbank/js/perbank3/userBrowseSidStack.js?ver=2017122122"></script>
<script src="
/icbc/newperbank/js/perbank3/js0003.js?ver=2017122122"></script>
<script src="
/icbc/newperbank/js/perbank3/jquery.lazyload.js?ver=2017122122"></script>
<script src="
/icbc/newperbank/perbank3/js/frame/js/style.js?ver=2017122122"></script>
<script src="
/icbc/newperbank/perbank3/js/frame/js/index.js?ver=2017122122"></script>
<script src="
/icbc/newperbank/perbank3/js/frame/js/banner.js?ver=2017122122"></script>
<script src="
...
<script src="
/icbc/newperbank/js/includes/pebank_browsercompatible.js?ver=2017122122"></script>
...
<link href="/ebdpui/pc4promote/style/default/floatdialog/ebdp-pc4promote-floatdialog.css?ver=1.0.17" rel="stylesheet" type="text/css"/>
<script src="/ebdpui/pc4promote/ebdp-pc4promote-floatdialog.js?ver=1.0.17"></script>
...
<script src="/ebdpui/pc4promote/ebdp-pc4promote-core.js?ver=1.0.17"></script><!-- 智能导航栏  -->
<link href="/ebdpui/pc4promote/style/default/navigationbar/ebdp-pc4promote2ebankc-navigationbar.css?ver=1.0.17" rel="stylesheet" type="text/css"/><!-- 智能导航栏  -->
<script src="/ebdpui/pc4promote/ebdp-pc4promote-navigationbar.js?ver=1.0.17"></script><!-- 智能导航栏  -->
</head>
	  ...
	  var b=co.indexOf(mn);//guide_nologon是否存在
		/*if (b < 0) {
			a= "";
		     ...
		     if(a==""){
					var	url="/icbc/newperbank/perbank3/frame/frame_guide_nologon.jsp";
					try{
...
<div class="header-box header-bg">
  <div class="header width">
    <div class="logo-box" onClick="javascript:logPV('PBL200202');perbankAtomLocationBW('PBL200202','',dse_sessionId);">
  		...
  		<img class="logo fl" src="/icbc/newperbank/perbank3/css/frame/images/logo.png">
...
<link href="/icbc/newperbank/css/includes/add_address.css" rel="stylesheet" type="text/css">
...
<div style="z-index:21;width:15px;height:19px;POSITION: absolute;top:-13px;left:154px;background:url(/icbc/newperbank/perbank3/style/style_default/images/address-top-angles.png) 0 bottom repeat-x;"></div>
...
<SCRIPT type=text/javascript>
	...
	function setAreaCodeCookie(){
		...
		Utils.setCookie("firstZoneNo", areaCodeParam, 7, getCurrentDomain());	
			...
			<li><a href="/icbc/Emall/main/forward.jsp?dse_sessionId=" class="icon-2" target="_blank">融e购</a></li>
...
DkggWQD7PZqclCfbVho7WFutMqxxDNt5wgEpw8Cz7ssPCDk=%2B" target="_blank" class="register-a">注册</a>
     </li>
  ...
  <div class="menu-box width">
    ...
    <ul class="menu-ul">
      ...
      <li><a href="javascript:logPV('PBL201786');perbankAtomLocationTW('PBL201786','',dse_sessionId);">账户列表</a></li>
      <li><a href="javascript:logPV('PBL201720');perbankAtomLocationTW('PBL201720','',dse_sessionId);">安全</a></li>
      <li><a href="javascript:logPV('PBL201724');perbankAtomLocationTW('PBL201724','',dse_sessionId);">设置</a></li>
    </ul>
    <div class="E-bank ">
    <div class="E-bank-myBank" onclick="logPV('PBL201700');perbankAtomLocationTW('PBL201700','',dse_sessionId,'',oratype);" title="点击查看我的网银！">
    	<b class="user-img"></b><span>我的网银</span>
    </div>
    <div class="E-banl-down-nemu">
    	<ul>
    		<li onclick="logPV('PBL201700');perbankAtomLocationTW('PBL201700','',dse_sessionId);"><a href="javascript:void(0);"><span class="jrrl-bg"></span>金融日历</a></li>
        	<li onclick="logPV('PBL201786');perbankAtomLocationTW('PBL201786','',dse_sessionId);"><a href="javascript:void(0);"><span class="kabao-bg"></span>账户列表</a></li>
...
.pic-box {height:40px;background:url(/icbc/newperbank/perbank3/images/quickFunc/zuiai_add_v.png) center bottom no-repeat;}
.pic-box1 {height:40px;background:url(/icbc/newperbank/perbank3/images/quickFunc/zuiai_add_r.png) center bottom no-repeat;}
</style>
...
<script src="/icbc/newperbank/js/ajax/json2.js"></script> 
<script src="/icbc/newperbank/js/ajax/datastruct-ajax-eb.js"></script> 
<script src="/icbc/newperbank/js/perbank3/ie8indexOf.js;"></script> 
<script type="text/javascript">
...
commandname[24]={'isfavourit':'1','locationno':'PBL201786','chname':'我的账户'};
...
try{
	var myfavServices='PBL201786|PBL200812|PBL200811|PBL200779|PBL201097|PBL300101|PBL201139|PBL200317|PBL200603|PBL200745|PBL20164001|PBL100410';
...
<!-- <div id="myQuickFucDiv" style="display: none;">
	...
	<div id="quickfuc_float_jsp_id">   -->
			<!-- 	<iframe marginWidth="0" id="myQuickFucDiv" 
					src="/icbc/newperbank/perbank3/quickFuc/myQuickFuc.jsp"
			  ...
			  for(i=0;i<cokz.length;i++){
			  	if(cokz.length>=12){
			  		...
			  		//if(CookieZ.indexOf(serviceIds[i])>-1){
						...
						html_content = html_content + '<a class="active" style="cursor:pointer;" href="#"><img id="'+cokz[i]+'"  src="/icbc/newperbank/perbank3/images/quickFunc/'+cokz[i]+'_r.png" />';
						if(chname.length<=5){
				...
				html_content = html_content + '<a class="active"  style="cursor:pointer;" href="#"><img id="tj1" style="margin-top:7px;margin-bottom:7px;" onmouseenter="tj1(this.id)" onmouseleave="th1(this.id)" src="/icbc/newperbank/perbank3/images/quickFunc/zuiai_add_r.png" />';
			...
			/*  alert(serviceIds);
			 ...
			 if(serviceIds.length>11){
				for(i=0;i<12;i++){
					...
					html_content = html_content + '<a class="active"  style="cursor:pointer;" href="#"><img id="'+serviceIds[i]+'"   src="/icbc/newperbank/perbank3/images/quickFunc/'+serviceIds[i]+'_r.png" />';
					if(chname.length<=5){
...
try{
 ...
 function tj(id){
document.getElementById(id).src="/icbc/newperbank/perbank3/images/quickFunc/"+id+"_v.png"
}
function th(id){
document.getElementById(id).src="/icbc/newperbank/perbank3/images/quickFunc/"+id+"_r.png";

}
function tj1(id){
document.getElementById(id).src="/icbc/newperbank/perbank3/images/quickFunc/zuiai_add_v.png";
}
function th1(id){
document.getElementById(id).src="/icbc/newperbank/perbank3/images/quickFunc/zuiai_add_r.png";
...
<script src="/icbc/newperbank/js/perbank3/common.js?ver=2017122122"></script>
<script src="
/icbc/newperbank/js/perbank3/jquery.menu-aim.mini.js?ver=2017122122"></script>
<script src="
/icbc/newperbank/js/perbank3/ie8indexOf.js?ver=2017122122"></script>

<style>
/*<最爱加号弹窗*/
.zuiai-fix-bg1{ width:100%; height:100%; background:url(/icbc/newperbank/perbank3/css/frame/images/bg-hui.png) repeat; position:fixed; top:0; left:0; z-index:1000; display:none;}
...
.zuiai-fix-bg1 .zuiai-fix-box1 .zuiai-fix-body1 .zuiai-fix-item1 .uiai-fix-item-ul li>a .fix-b.on{ background:url(/icbc/newperbank/perbank3/images/quickFunc/zuiai-fix-on.png) center center no-repeat;}
.zuiai-fix-bg1 .zuiai-fix-box1 .zuiai-fix-body1 .zuiai-fix-item1 .uiai-fix-item-ul li>a .fix-b{ background:url(/icbc/newperbank/perbank3/images/quickFunc/zuiai-fix-nor.png) center center no-repeat;}
.both{ clear:both;}
.closeLayer{
   cursor: hand;
   z-index:99;
...
.haveimg{
    height:55px;
    width: 55px;
	background-image:url(/icbc/newperbank/perbank3/images/quickFunc/landi.png)
}
.search-box1 {
    border-radius: 8px;
    margin-top: 6px;
    background: url(/icbc/newperbank/perbank3/css/frame/images/search-bg.png) 0 0 no-repeat;
...
.search-box1 > b {
    ...
    width: 20px;
    height: 21px;
    background: url(/ebdpui/pc4promote/style/default/conditionchoose/manage-icon.png) center center no-repeat;
    cursor: pointer;
}
.place-holder{
		position: absolute;
...
function darwLi(){
	$("#oldall").hide();
	$("#all").show();
var myquickAll1="PBL201786|PBL200711|PBL200715|PBL200773|PBL200771|PBL200714|PBL200721|PBL200743|PBL100410";
		...
		if (arr0!=undefined && arr0!= null && arr0!=''){
			$.each(arr0, function (i, data) {
			   ...
			   curMap = parent.getLocationMap(data);
				...
				var img_data = '<a onmouseenter="tjyx(\''+data+'\')" onmouseleave="scyx(\''+data+'\')"><b onclick="del(\''+data+'o\');" id="'+data+'a"  ></b><div id="'+data+'div" class="img_square1"><span><img _t="img" name="'+data+'" id="'+data+'img"  class="img_square"  alt="'+dataName+'" src="/icbc/newperbank/perbank3/images/quickFunc/'+data+'_r.png"/></span></div></a>';
	...
	$('#all').find('ul').html('');
		...
		if (arr!=undefined && arr!= null && arr!=''){
			$.each(arr, function (i, data) {
				...
				var IdName=$.trim(dataName);
				var img_data = '<a onmouseenter="tjqt(\''+data+'\')" onmouseleave="scqt(\''+data+'\')"><b onclick="add(\''+data+'o\');" id="'+data+'a"   ></b><div id="'+data+'div" class="img_square1"><span ><img _t="img" name="'+data+'" id="'+data+'img"   class="img_square" alt="'+dataName+'" src="/icbc/newperbank/perbank3/images/quickFunc/'+data+'_r.png"/></span></div></a>';
						if(newdataname.length<=4){
							newdataname="<p style='font-size:12px; color:#888889; margin-top:-20px;'>"+newdataname+"</p>";
						}else{
							var nameq="";
...
function xh1(arr,a){
	...
	$.each(arr, function (i, data) { 
	        ...
	        if(newdataname!=""&&newdataname!=null){
				...
				var IdName=$.trim(dataName);
				var img_data = '<a onmouseenter="tjqt(\''+data+'qi\')" onmouseleave="scqt(\''+data+'qi\')"><b onclick="add(\''+data+'oqi\');" id="'+data+'aqi"   ></b><div id="'+data+'divqi" class="img_square1"><span ><img _t="img" name="'+data+'" id="'+data+'imgqi"   class="img_square" alt="'+dataName+'" src="/icbc/newperbank/perbank3/images/quickFunc/'+data+'_r.png"/></span></div></a>';
						if(newdataname.length<=4){
							newdataname="<p style='font-size:12px; color:#888889; margin-top:-20px;'>"+newdataname+"</p>";
						}else{
							var nameq="";
 	...
 	<div class="banner-bolck"> 
		<div class="banner-box">
			<!-- type参数的数据字典：0金融频道首页  1理财 2基金 3保险 4账户贵金属  14新网银首页 -->
	   	   <iframe id="perbank-content-frame-adv"  name="perbank-content-frame-adv" frameborder="no"  scrolling="no" VSPACE="0" style="top:0;height:100%;width:100%;border:0 none;overflow:hidden;"  class="content-frame" src="/icbc/newperbank/perbank3/frame/frame_index_ads.jsp" ></iframe>
	    </div>
...
<script type="text/javascript">
	 function goToAd(){
		...
		var actiontype = "1";
 		var action = "https://epass.icbc.com.cn/regist/regist_index.jsp"; 
...
<script src="/icbc/newperbank/js/ajax/datastruct-ajax-eb.js?ver=2017122122"></script>
<script src="/icbc/newperbank/js/ajax/json2.js?ver=2017122122"></script>
...
<div class="attention-block">
	<div class="attention-box width">
 		<ul class="attention-ul">
        	  <li>
            	<div class="pic"><img class="lazy" alt="" data-original="/icbc/newperbank/perbank3/css/frame/images/icon-attention-1.png"/></div>
            	<a href="http://www.icbc.com.cn/icbc/%e7%94%b5%e5%ad%90%e9%93%b6%e8%a1%8c/%e5%ae%89%e5%85%a8%e4%b8%93%e5%8c%ba/" target="_blank" 
  				...
  				<a href="/icbc/newperbank/main/risk_tip_new.jsp" target="_blank" >风险提示</a>
  					<a href="http://www.icbc.com.cn/ICBCCOLLEGE/client/page/PageShow.aspx"  target="_blank"
  					title="使用网上银行时的常见问题及解决方法。" >热点问题</a>
    		 </li>
        	 <li>
            	<div class="pic"><img class="lazy" alt="" data-original="/icbc/newperbank/perbank3/css/frame/images/icon-attention-2.png"/></div>
  					<a href="/icbc/newperbank/logonFreeze.jsp"  target="_blank"
  					title="点击进入自助关闭网上银行登录。" >网银关闭</a>
  				<a href="/icbc/newperbank/wapLogonFreeze.jsp"  target="_blank"
  					 title="点击进入自助关闭手机银行登录" >手机银行关闭</a>
 					
        						<a href="http://www.icbc.com.cn/icbc/网银安全控件/default.htm" target="_blank" >小e安全检测</a>
       				
 			 </li>
				
        	<li>
            	<div class="pic"><img class="lazy" alt="" data-original="/icbc/newperbank/perbank3/css/frame/images/icon-attention-3.png"/></div>
...
DkggWQD7PZqclCfbVho7WFutMqxxDNt5wgEpw8Cz7ssPCDk=%2B"   target="_blank"
  				...
  				<a href="/icbc/newperbank/main/login_agr_new.jsp" target="_blank" >电子银行章程 </a>
  				
  				<!-- <a href="/icbc/newperbank/logonIdsearch125.jsp"  target="_blank" >找回用户名</a> -->
  				<a href="javascript:AtomSerivceSubmit('PBL100200');">体验评价</a>
  			</li>
        	<li>
            	<div class="pic"><img class="lazy" alt="" data-original="/icbc/newperbank/perbank3/css/frame/images/icon-attention-4.png"/></div>
  					<a href="/icbc/newperbank/bankbook/bankbook_index.jsp" 
  					title="使用中国工商银行的活期存折账号和密码登录，您就可以办理账户查询业务。"   target="_blank">存折版登录</a>
  					<a href="https://corporbank-simp.icbc.com.cn/icbc/normalbank/index.jsp"    target="_blank">企业网上银行</a>
  					<a href="/icbc/newenperbank/perbank3/frame/frame_index.jsp" target="_blank">Personal Internet Banking</a>
 			...
 			<li>
            	<div class="pic"><img class="lazy" alt="" data-original="/icbc/newperbank/perbank3/css/frame/images/icon-attention-5.png"/></div>
...
<div id="hall_div" style="position:fixed; width:auto; height: auto; right:0px; top: 200px; display: block; z-index:1; display:none;">
	...
	<script src="/icbc/newperbank/js/perbank3/js0005.js?ver=2017122122"></script>
	...
	addPvValue(['url','/icbc/newperbank/perbank3/frame/frame_index.jsp']);
...
var link1 = function(){
	...
	contentDom.html("<iframe  id='quickTran' name='quickTran'  frameborder='0' width='300px' height='100%' style='margin-top:-8px' src='/icbc/newperbank/perbank3/quickFuc/quickTrans.jsp?dse_sessionId='></iframe>");
};
var link2 = function(){
	var contentDom=navigationbar.getContentDom();
...
var link6 = function(){
	var contentDom=navigationbar.getContentDom();
	contentDom.html("<iframe id='fundCompare' name='fundCompare' frameborder='0' width='100%' height='100%' style='margin-top:-5px' src='/icbc/newperbank/perbank3/fund/frame_fund_compare.jsp?dse_sessionId='></iframe>");
};
var link7 = function(){
...
//图片懒加载
	$("img.lazy").show().lazyload({
	   		placeholder: "/icbc/newperbank/perbank3/css/frame/images/loadering.gif"
	});
})
</script>
</body>
...
<link href="/icbc/newperbank/perbank3/css/frame/css/style.css?ver=2017122122" rel="stylesheet" type="text/css"/>
