	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('../newperbank/images/corpor2.gif','../newperbank/images/returnhome2.jpg')">
		...
		<table border="0" cellspacing="0" cellpadding="0" align="center">
			<tr>
				<td width="20"></td>
				<td width="570">
					<p style="line-height: 150%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您可在系统验证自己身份信息后，来完成自助关闭手机银行的操作。关闭成功后，将无法登录您的手机银行，如需再次使用手机银行，请携带您的注册卡、有效证件到当地的工行营业网点办理“取消手机银行登录限制”。</p>
				</td>
			</tr>
		</table>
						...
						<tr>
							...
							<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
									<tr align="center">
										<td height="25" colspan="3"><b><FONT size=3>自助关闭手机银行登录</FONT></b></td>
									</tr>
									<tr>
										<td height="30">&nbsp;</td>
...
<IFRAME frameBorder="0" name="VerifyimageFrame" id="VerifyimageFrame" scrolling="no" src="/servlet/com.icbc.inbs.person.servlet.Verifyimage2?randomKey=151609159614797762&imageAlt=点击图片可刷新" marginHeight=0 marginWidth=0 style="vertical-align:middle;" height=28 width=80 onload="this.contentWindow.document.oncontextmenu =  function(){return false;};">
</IFRAME>
...
if(navigator.userAgent.toLowerCase().indexOf("chrome/")!=-1){//这里注意chrome的useragent也包含safari
	VerifyimageFrame.location.href="/servlet/com.icbc.inbs.person.servlet.Verifyimage2?randomKey=151609159614797762&imageAlt=点击图片可刷新"+"&appendRandom="+(new Date()).getTime();
...
function refreshVerifyimage(){
	if(navigator.userAgent.toLowerCase().indexOf("chrome/")!=-1){//这里注意chrome的useragent也包含safari
		var url = "/servlet/com.icbc.inbs.person.servlet.Verifyimage2?randomKey=151609159614797762&imageAlt=点击图片可刷新"+"&appendRandom="+(new Date()).getTime();
...
*/
									...
									<tr>										
										<td height="20" colspan="3">
											&nbsp;&nbsp;&nbsp;&nbsp;尊敬的客户：如果发现您的手机银行有可能被盗用、或近期内不使用手机银行，可以通过本功能自助关闭手机银行的登录权限，关闭后将不能登录手机银行或进行B2C支付。
									...
									<tr>										
										<td height="20" colspan="3">
											&nbsp;&nbsp;&nbsp;&nbsp;如需再次使用手机银行，请您本人携带注册卡及有效证件到我行当地的营业网点办理“取消手机银行登录限制”。
										</td>
									</tr>
									<tr>										
										<td height="20" colspan="3">
